...
;(function() {
  ...
  var changeProductOrderInfo = function(target) {
    ...
    var productSize = productSizeItem ? product.querySelector('.product__size.is-active').textContent : '';
...
//     var mapOptions = {
//       center: { lat: 50.4501, lng: 30.5234 }, // Kyiv, Ukraine
//       zoom: 16
//     };
...
//     script.src = 'https://maps.googleapis.com/maps/api/js?key=YOUR_GOOGLE_MAPS_API_KEY&callback=googleMapInit';
//     document.body.appendChild(script);
//   };

//   var checkGoogleMapInit = function() {
...
//       googleMapLoad();
//       window.removeEventListener('scroll', checkGoogleMapInit);
//     }
//   };

//   window.addEventListener('scroll', checkGoogleMapInit);
//   checkGoogleMapInit();
// })();
/* map end */
